...
function createKinnaverWordpress_20241123() {
  try {
    ...
    const dico = new GAS_UTILS.DiscordNotifier(discord_webhook_url_myself_dohokins);
    dico.sendText("createKinnaverWordpress_20241123 오류: " + error);
  }
}
...
function createKinnaverWordpress_20241123_10() {
  try {
    ...
    const dico = new GAS_UTILS.DiscordNotifier(discord_webhook_url_myself_dohokins);
    dico.sendText("createKinnaverWordpress_20241123_10 오류: " + error);
  }
}
